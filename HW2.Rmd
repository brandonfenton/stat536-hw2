...
```
    ...
    $\widehat{MMXT}=-69.29+0.05167 \times FYEAR+3.7014 \times MONTH1+11.189 \times MONTH2+21.977 \times MONTH3+31.224 \times MONTH4+39.708 \times MONTH5+49.565 \times MONTH6+48.466 \times MONTH7+37.629 \times MONTH8+25.822 \times MONTH9+10.315 \times MONTH10+1.7329 \times MONTH11$
...
bzt.fit3.ttable <- as.data.frame(bzt.fit.ttable)
