...
After re-estimating the model with fraction year data, the following model is obtained:
  ...
  $\widehat{MMXT}=-69.29+0.05167*\widehat{FYEAR}+3.7014*\widehat{MONTH1}+11.189*\widehat{MONTH2}+21.977*\widehat{MONTH3}+31.224*\widehat{MONTH4}+39.708*\widehat{MONTH5}+49.565*\widehat{MONTH6}+48.466*\widehat{MONTH7}+37.629*\widehat{MONTH8}+25.822*\widehat{MONTH9}+10.315*\widehat{MONTH10}+1.7329*\widehat{MONTH11}$
...
=======
pander(Tukey_results$confint, caption = "Tukey comparisons of month effects (95% familywise confidence level)")
>>>>>>> parent of dd5b3fe... Hats off
