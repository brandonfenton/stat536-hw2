...
With $F_{`r cat(anova(bzt.fit2)["FYEAR:MONTH", "Df"])` ,\; `cat(anova(bzt.fit2)["Residuals", "Df"])` } = `r cat(anova(bzt.fit2)["FYEAR:MONTH", "F value"]) `$ (p-value = $`r cat(anova(bzt.fit2)["FYEAR:MONTH", "Pr(>F)"])`$) there is strong evidence that
